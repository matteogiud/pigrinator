#include "stepper_car.h"

StepperCar::StepperCar(Stepper motor_1, Stepper motor_2)
{
...
StepperCar::forward_cm(int distance_cm)
{
...
StepperCar::backward_cm(int distance_cm){
  int steps_to_do = abs((int)distance_cm * this->steps_per_round_complete / this->wheels_circumference_cm);
